...
DECLARE @DATEFROM AS DATE ='12-01-2022', @DATETO  AS DATE ='12-30-2022',
...
END AS 'JE-COST',
CASE 
	WHEN D.TYPE='AR Credit Memo' 
	THEN (D.COST*D.[Quantity Sold])*-1 
	ELSE D.COST*D.[Quantity Sold] 
END  AS 'Total Cost',
CASE 
	WHEN D.SWW='FREEBIES' AND D.[Total Sales]=0 
	THEN 0
	WHEN D.TYPE='AR Credit Memo' 
