        ...
        CASE
            WHEN YEAR(TAXDATE) <> YEAR(createDate) THEN
                ...
                (
                    ...
                    AND TaxDate BETWEEN DATEADD(YEAR, -1, @PERIODFROM) AND DATEADD(DAY, -1, @PERIODFROM)
                    AND TransType <> 18
                    ORDER BY  TransSeq DESC,TaxDate DESC
...
FROM(
    ...
    where ItemCode LIKE '%'+@ITM+'%'
    and Warehouse=@STR 
    and TransType IN (20,67,69) and  TaxDate BETWEEN @PERIODFROM and @PERIODTO 
    ...
    where ItemCode LIKE '%'+@ITM+'%'
    and Warehouse=@STR 
    and TransType =10000071 and TransValue <>0 and  TaxDate BETWEEN @PERIODFROM and @PERIODTO  
