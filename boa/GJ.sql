-- DECLARE @BRANCH VARCHAR(50)='{?Branch}',
--         @DATEFROM DATE={?DateFrom},
--         @DATETO DATE={?DateTo}


DECLARE @BRANCH VARCHAR(50)='',
        @DATEFROM DATE='01-01-2022',
...
T0.TaxDate AS Date, T0.CreateDate,T0.UPDATEDATE,
...
UNION ALL
 ...
 INNER JOIN (
            ...
            -- COMMENETED ON FEB132024 BY MAAM WINNIE ,TRANSFERED TO CASH R 
...
where [JE Entry] in (31918)
-- WHERE CreateDate < '2024-01-30'
-- and UpdateDate < '2024-01-30'
