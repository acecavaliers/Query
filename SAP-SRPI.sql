...
LEFT JOIN (	
			...
			-- UNION ALL
			SELECT DISTINCT A2.INMPrice,A2.DocEntry,A0.BaseEntry,A2.Quantity,A2.ItemCode,A2.WhsCode,A2.ObjType,A3.TAXDATE,'PO'AS 'RTYPE',a2.DocEntry AS 'PO_#',A2.unitMsr,
			...
			AND T5.ItemCode=T0.ItemCode AND T5.WhsCode=T0.WhsCode AND T5.unitMsr=T0.unitMsr
